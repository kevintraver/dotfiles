...
vim.cmd[[
  ...
  autocmd FileType NeogitCommitMessage,gitcommit nnoremap <buffer> <M-s> :wq!<CR>
  autocmd FileType NeogitCommitMessage,gitcommit inoremap <buffer> <M-s> <c-\><c-n>:wq!<CR>
]]
